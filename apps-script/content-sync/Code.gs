...
// struck through rather than disappearing. This is the standing (non-holiday)
// week: Monday NYPM is the only off slot, not a full-day closure — the next
// hand update to index.html's schedule should update this seed in the same
// commit, exactly as it did this time. Rows s1, s3, and s9 changed from the
// previous (Labor Day week) seed: Monday NYAM/ASIA went back from off to
// live, and Wednesday NYPM regained Gainz.
var SCHEDULE_SEED = [
