...
export const LESSON_LIBRARY = Object.freeze([
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "s3", heading: "Worked answer and rubric", text: "(a) Delta at $105 is 0.827, so 0.827 × 1,000 = 827 shares . (b) 0.511(5) + 0.5(0.0748)(25) = 2.555 + 0.935 = 3.490 ; the grid gives 5.53 − 2.13 = 3.40, so the estimate is $0.09 (2.6%) too high , because gamma falls from 0.0748 to 0.0457 across the move and the formula assumed it was constant. (c) 3.40 × 1,000 = +$3,400 on $2,130 of premium = +160% . Rubric: full marks require the share figure, both terms of the expansion shown separately, and a stated reason the estimate runs high. An answer that reports 3.49 as \"the\" P&L without noticing the error has learned the formula and missed the lesson." },
    ],
  },
]);
